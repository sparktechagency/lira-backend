...
router.get('/posts', auth(USER_ROLES.USER, USER_ROLES.SUPER_ADMIN), CommunityController.getCommunityPosts);
router.get('/posts/:postId', auth(USER_ROLES.USER, USER_ROLES.SUPER_ADMIN), CommunityController.getSingleCommunityPost);
